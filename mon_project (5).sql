...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2018 at 04:19 PM
...
(6, '4', 'client3', '2018-06-14', 'kljqefh zelui h', 0),
(7, '3', 'latifa', '2018-06-08', 'mh lkj hlh ljh', 1);
...
(5, 'basha', 'amiral', 123654569, '2018-06-08', '2', '19h45', 'liu uigylui gyuyg uy guygyu g yu guy gyu'),
(6, 'basha', 'amiral', 123654569, '2018-06-08', '2', '19h45', 'liu uigylui gyuyg uy guygyu g yu guy gyu'),
(7, 'root', 'rooot', 2147483647, '1990-02-07', '5', '19h0', 'saluta tous je suis ici ');
...
--
ALTER TABLE `avis`
  MODIFY `id_avis` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `reserver`
  MODIFY `id_reserver` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
